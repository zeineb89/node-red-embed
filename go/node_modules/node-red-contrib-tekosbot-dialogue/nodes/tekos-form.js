...
function GetFormContent(config){
  ...
  for(var i=0; i<option.length; i++){
    ...
    switch(option[i].type){
      ...
      case 'url':
      case 'email':
      case 'password': {inputs.push({"type": 'input',"subtype": option[i].type,"label":option[i].label ,"name": option[i].value}); break;}
      case 'checkbox': {inputs.push({"type": option[i].type,"label":option[i].label ,"name": option[i].value,'default': false}); break;}
      case 'datetime': {inputs.push({"type": option[i].type,"subtype": option[i].type,"label":option[i].label ,"name": option[i].value}); break;}
      case 'switch': {inputs.push({"type": "toggle","subtype": "toggle","label":option[i].label ,"name": option[i].value }); break;}
      case 'list': { inputs.push({
