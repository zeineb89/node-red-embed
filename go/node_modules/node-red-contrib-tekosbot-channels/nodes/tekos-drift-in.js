...
module.exports = function(RED) {
        ...
        if (RED.settings.httpNodeRoot !== false) {
            ...
            this.callback = function(req,res) {
                ...
                if (node.method.match(/^(post|delete|put|options|patch)$/)) {
                    node.send({_msgid:msgid,req:req,res:createResponseWrapper(node,res),payload:req.body, conversationId:req.body.data.conversationId});
    ...
    RED.nodes.registerType("drift in",HTTPIn);
