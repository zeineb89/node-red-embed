...
module.exports = function(RED) {
  ...
  function ChatBotTextSpeech(config) {
    ...
    this.on('input', function(msg) {
      ...
      template(message)
        .then(function(message) {
          // // payload
          msg.payload.say = message; 
          msg.payload.langue= parseInt(langue);
  ...
  RED.nodes.registerType('chatbot-text-speech', ChatBotTextSpeech);
};
